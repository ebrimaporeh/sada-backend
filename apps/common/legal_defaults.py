...
mentions it without anyone editing this content. The admin editor's
"Insert variable" menu shows every supported tag.
"""
...
{{site_name}} uses a keep-it-all model. Campaign owners receive all funds raised regardless of whether the goal is met.
...
You retain ownership of content you upload (photos, campaign stories). By uploading content, you grant {{site_name}} a non-exclusive licence to display that content on the platform for the purpose of operating the service.

## 8. Limitation of Liability
{{site_name}} is a platform that facilitates fundraising. We do not guarantee that campaign goals will be reached or that funds will be used as stated by campaign owners. We are not liable for losses arising from fraudulent campaigns beyond the funds held in our systems at the time a complaint is raised.
